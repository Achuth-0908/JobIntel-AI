...
class JobMatcher:
    ...
    def setup_vectorizer(self):
        ...
        try:
            # Combine description and skills for vectorization
            job_texts = []
    ...
    def find_matching_jobs(self, resume_skills, resume_text, top_n=5):
    ...
    def get_job_recommendations(self, resume_skills, resume_text, top_n=5):
